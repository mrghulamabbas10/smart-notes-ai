...
export default function Workflow() {
  const steps = [
    {
      ...
      description:
        "Enter the Patient identifier & start the encounter. SmartNotesAI listens to the Doctor patient conversation and transcribe it on real time.",
    ...
    },
    {
      ...
      description:
        'Once Encounter is finish, hit on "End Encounter", our AI based solution will generate Clinical Notes, Billing Information and Patient Summaries within seconds.',
    ...
    },
    {
      ...
      title: "Push to EMR",
      description:
        "Review the notes and Push them to EMR of your choice (Epic, Cerner, Athena Health etc) instantly. You are done, No more documentation Stress!!",
  ...
  return (
    <section id="workflow" className="w-full bg-white py-16 sm:py-24 lg:py-32">
        ...
        <div className="grid gap-8 lg:grid-cols-3">
          {steps.map((step, index) => (
            <div key={index} className="rounded-3xl bg-[#F1F5F8] p-8 !sticky top-20">
              ...
              <h3 className="mb-4 font-satoshi text-xl font-bold text-[#120A0B]">
                {step.title}
              </h3>
              ...
              <div className="rounded-2xl bg-white p-6">
                  ...
                  <div className="space-y-4">
                    <div className="flex gap-4 md:flex-row flex-col">
                      <div className="flex-1">
                        <label className="mb-2 block font-urbanist text-xs font-semibold text-black/70">
                          Patient Name
                        </label>
                        <div className="flex items-center gap-2 rounded-full border border-black/10 px-4 py-3">
                          <UserIcon />
                          <span className="font-urbanist text-xs text-black/40">
                            e.g. Patient 1
                          </span>
                        </div>
                      </div>
                    ...
                    <div>
                      ...
                      <div className="flex items-center gap-2 rounded-full border border-black/10 px-4 py-3">
                        <FileIcon />
                        <span className="font-urbanist text-sm text-black/40">
                          e.g. Patient 1
                        </span>
                      </div>
                    </div>
                    <button className="w-full -rotate-[7deg] rounded-3xl bg-[#3C82F5] py-3 font-urbanist text-base font-medium text-white transition hover:bg-[#2E6BCC]">
                      Start Encounter
                    </button>
                  </div>
                )}
                ...
                {index === 1 && step.notePreview && (
                  <div className="space-y-4">
                    <div className="font-urbanist text-sm font-medium text-black">
                      Progress Note
                    </div>
                    <div>
                      <div className="mb-2 font-urbanist text-xs text-[#696A6B]">
                        Subjective:
                      </div>
                      <div className="rounded-2xl bg-[#A9E8FB]/14 p-4">
                        <div className="font-urbanist text-sm leading-relaxed">
                          <span className="font-bold text-[#343434]">
                            Chief Complaints:{" "}
                          </span>
                          <p className="text-[#616566]">
                            No chief complaints or symptoms were mentioned in
                            the transcript.
                          </p>
                        </div>
                      </div>
                    </div>
                    <div className="rounded-2xl bg-[#A9E8FB]/20 p-4">
                      <div className="font-urbanist text-[10px] leading-relaxed">
                        <span className="font-bold text-[#343434]">
                          History of Present Illness (HPI):{" "}
                        </span>
                        <p className="text-[#616566]">
                          There is no relevant history of the present illness
                ...
                {index === 2 && step.showPushButton && (
                  <div className="space-y-6 p-5">
                    <button className="flex w-full items-center justify-center gap-2 rounded-[26px] bg-[#A9E8FB] px-6 py-4 font-urbanist text-[15px] font-medium text-[#616566] transition hover:bg-[#8DD5E8]">
                      Push to EHR
                      <UpArrow />
                    </button>
                    <div className="rotate-[5.897deg] rounded-2xl border border-[#FEFEFE] bg-[#E5F9FF] p-1">
                      <div className="rounded-2xl border border-black/10 bg-white p-4">
                        <div className="flex items-center gap-2">
                          <CheckGreenIcon />

                          <span className="font-urbanist text-[15px] text-black">
                            Done
                          </span>
                        </div>
                      </div>
