      ...
      <div className="relative z-10 mx-auto max-w-7xl px-4 md:pt-20 pt-10 sm:px-6 lg:px-8">
        <div className="flex flex-col items-center text-center">
          ...
          >
            ...
            />
            <h1 className="md:text-5xl text-[11vw] md:leading-tight leading-[11vw] font-bold text-[#00234B] sm:text-6xl lg:text-[92px]">
              Notes
            </h1>
            <h1 className="md:text-5xl text-[11vw] md:leading-tight leading-[11vw] font-bold text-[#00234B] sm:text-6xl lg:text-[92px]">
              with
          ...
          <motion.p
            ...
            className="mx-auto md:mb-12 mb-8 max-w-3xl text-[#464E68] text-base  sm:text-lg lg:text-xl"
          >
