...
const SiriOrbDemo = () => {
  const [selectedSize, setSelectedSize] = useState("192px")
  ...
  return (
    <div className="flex flex-col items-center">
      ...
      {showSettings && (
        <div
          className="bg-background absolute right-4 bottom-[64px] flex w-fit flex-col justify-between gap-4 rounded-lg border p-4">
          <div>
