...
export default function SpecialitiesHero() {
  ...
  return (
    <section
      ref={ref}
      className="relative w-full overflow-hidden bg-gradient-to-br from-[#EFF9FF] via-[#EFF9FF] to-[#FFF9EF] h-[120vw] md:h-[44vw]"
    >
      {/* Background Image */}
      ...
      <div className="relative z-10 mx-auto max-w-7xl px-4 md:pt-32 pt-24 sm:px-6 lg:px-8 ">
        <div className="space-y-3">
          ...
          >
            Discover our comprehensive range of medical specialities, each
            staffed with expert healthcare professionals dedicated to providing
            exceptional care.
          </motion.p>
        </div>
      </div>
